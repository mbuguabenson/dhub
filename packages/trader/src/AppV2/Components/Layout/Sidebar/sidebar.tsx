...
const Sidebar = observer(() => {
    ...
    const handleDTraderClick = () => {
        setSidebarFlyout(null);
        history.push(routes.dtrader);
    };
    ...
    const isDTraderActive = isActiveRoute(routes.dtrader);
    ...
    const navigationItems: TSidebarItem[] = [
        ...
        },
        {
            ...
            onClick: handleDTraderClick,
            isActive: isDTraderActive,
            dataTestId: 'dt_sidebar_dtrader',
        },
        {
            id: 'positions',
